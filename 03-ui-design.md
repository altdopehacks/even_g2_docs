...
even-toolkit の実装に基づく最新値です。

| トークン | 値 | 用途 |
|---|---|---|
| `--color-text` | `#232323` | プライマリテキスト |
| `--color-text-dim` | `#7B7B7B` | サブテキスト・キャプション |
| `--color-bg` | `#EEEEEE` | ページ背景 |
| `--color-surface` | `#FFFFFF` | カード・行の背景 |
| `--color-accent` | `#232323` | アクセント（ボタン・ハイライト） |
| `--color-positive` | `#4BB956` | 成功・正常状態 |
| `--color-negative` | `#FF453A` | エラー・警告状態 |
| `--radius-default` | `6px` | ボーダー半径 |
